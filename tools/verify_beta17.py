...
ok('VERSION = "5.8.0-beta.17"' in cfg,'version is 5.8.0-beta.17')
...
ok('version = "5.8.0-beta.17"' in meta,'plugin metadata version is beta.17')
...
ok('SCHEMA = 132' in cfg,'beta.17 keeps schema 132')

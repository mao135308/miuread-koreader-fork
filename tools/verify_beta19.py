...
ok('VERSION = "5.8.0-beta.19"' in cfg,'version is 5.8.0-beta.19')
ok('SCHEMA = 134' in cfg,'schema is 134')
...
ok('version = "5.8.0-beta.19"' in meta,'plugin metadata version is beta.17')
...
ok('SCHEMA = 134' in cfg,'beta.19 schema is 134')
...
if texlua.exists():
    for tool in ['test_extension_catalog.lua','test_extension_download.lua','test_extension_install.lua','test_store_repair.lua','test_store_shared.lua','test_digest_stream.lua','test_readtime_recovery.lua']:
